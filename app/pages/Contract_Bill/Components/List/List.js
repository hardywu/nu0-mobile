            ...
            <View style={[mStyles.mb10, styles.itemWrap]}>
                <View style={[mStyles.mCenterContent, styles.itemCenterContent]}>
                    <View style={styles.itemRow}>
                        ...
                        <Text style={[mStyles.mBlackColor, styles.itemRowText]}>买入平空</Text>
                        <Text style={[mStyles.mBlackColor, styles.itemRowText]}>2</Text>
                    </View>
                    <View style={styles.itemRow}>
                        ...
                        <Text style={[mStyles.mGrayColor, styles.itemRowText]}>2</Text>
                    </View>
                </View>
            </View>
        );
