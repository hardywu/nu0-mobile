...
const mainNavAnim = {
  ...
  scaleFadeOut: function() {
    return Anim.parallel([
      ...
      Anim.timing(this.style.scale, 0.92, 100, Easing.ease),
    ]);
  },
};
    ...
    let mainNavItemsDOM = mainNav.data.map((items, index) => {
      ...
      return (
        <View
          ...
          key={index}>
          <Image style={styles.mainNavCurItemIcon} source={items.icon} />
      ...
      <SafeAreaView style={mStyles.mFlex1}>
        ...
        <View style={mStyles.mFlex1}>
          <View style={styles.header}>
            <View style={[mStyles.mCenterContent, styles.headerCenter]}>
              ...
              <View
                ...
                <Text style={styles.mainNavCenterText}>
                  {mainNav.title}/CNY
                </Text>
                <Image
                  style={{
              ...
              <View style={styles.mainNavRight}>
                <Text style={[styles.mainNavRightText, mStyles.mRedColor]}>
                  ¥7823.21
                </Text>
              </View>
            </View>
          ...
          <View
            style={[
              styles.searchBar,
              subNavActiveIndex === 0 || subNavActiveIndex === 1
                ? mStyles.mFlex
                : mStyles.mHide,
            ]}>
            <View
          ...
          <View style={styles.list}>
            <View
              style={[
                mStyles.mFlex1,
                subNavActiveIndex === 0 ? mStyles.mFlex : mStyles.mHide,
              ]}>
              <BuyList data={this.state} setData={this._setState} />
            </View>
            <View
              style={[
                mStyles.mFlex1,
                subNavActiveIndex === 1 ? mStyles.mFlex : mStyles.mHide,
              ]}>
              <SellList data={this.state} setData={this._setState} />
            </View>
            <View
              style={[
                mStyles.mFlex1,
                subNavActiveIndex === 2 ? mStyles.mFlex : mStyles.mHide,
              ]}>
              <EntrustmentList data={this.state} setData={this._setState} />
            </View>
          </View>
          {/* 列表结束 */}
          {/* 货币选择开始 */}
          <Animated.View
            style={[
              styles.mainNavCur,
              {
                ...
                transform: [{ scale: mainNavAnim.style.scale }],
              },
            ]}>
