...
export default class Contract extends Component {
  ...
  render() {
    let { mainNav, trade, restingOrder, position, sideMenu } = this.state;
    ...
    for (let i = 0; i < trade.contractType.options.length; i++) {
        ...
        arr.push(
          <View
            style={[
              ...
              trade.contractType.value.type === i &&
              trade.contractType.value.code === j
                ? mStyles.mBlueBorder
                : '',
            ]}
            key={j}
            ...
            onResponderRelease={evt =>
              this.handleTradeContractOptionsItemRelease(evt, i, j)
            }>
            <Text
              style={[
      ...
      tradeContractOptionsDOM.push(
        <View style={styles.tradeContractOptionsItem} key={i}>
          <Text style={styles.tradeContractTypeText}>
            {trade.contractType.options[i].name}
          </Text>
          <View style={styles.tradeContractTypeChild}>{arr}</View>
        </View>,
      );
    }
    ...
    return (
      <SafeAreaView style={mStyles.mFlex1}>
        ...
        {/* 头部结束 */}
        {/* 导航开始 */}
        <View style={styles.nav}>{mainNavDOM}</View>
        {/* 导航结束 */}
        {/* 页面开始 */}
        <View style={styles.body}>
          ...
          <ScrollView
            ...
            <View style={styles.trade}>
              <View style={[styles.tradeHeader]}>
                <View
                  style={[
                    ...
                    styles.tradeHeaderCenterContent,
                  ]}>
                  <View
                    style={styles.tradeHeaderSelect}
                    onStartShouldSetResponder={() => true}
                    onResponderRelease={evt =>
                      this.handleTradeContractOptionsRelease(evt)
                    }>
                    <Text style={styles.tradeHeaderSelectText}>
                      {trade.contractType.options[trade.contractType.value.type]
                        .name + '  '}
                      {
                        trade.contractType.options[
                          trade.contractType.value.type
                        ].data[trade.contractType.value.code].name
                      }
                    </Text>
                    <Image
                      style={styles.tradeHeaderSelectArrow}
                      source={arrowIcon}
                    />
                  </View>
                  <View style={styles.tradeHeaderQuo}>
                    <Text
                      style={[styles.tradeHeaderQuoText, mStyles.mGreenColor]}>
                      $1.1228
                    </Text>
                    <Image
                      style={styles.tradeHeaderQuoIcon}
                      source={trendActiveIcon}
                    />
                  </View>
                </View>
              </View>
              <View style={styles.tradeBody}>
                <View
                  style={[mStyles.mCenterContent, styles.tradeCenterContent]}>
              ...
              <View
                ...
                <ScrollView
                  style={[
                    mStyles.mCenterContent,
                    styles.tradeContractOptionsCenterContent,
                  ]}>
          ...
          <View
            ...
            <View style={styles.filterWrap}>
              <View
                style={[styles.filterCenterContent, mStyles.mCenterContent]}>
                <View style={styles.filterItem}>
                  <View
                    ...
                    onStartShouldSetResponder={() => true}
                    onResponderRelease={evt =>
                      this.handleROFilterSelectRelease1(evt)
                    }>
                    <Text style={styles.filterItemValText}>
                      {restingOrder.filterSelect1.value.name}
                    </Text>
                    <Image
                      style={styles.filterItemValArrow}
                      source={arrowIcon}
                    />
                  </View>
                  <View style={styles.filterItemSelectOptions}>
                    <DcSelect
                      ...
                      onOptionsRelease={obj =>
                        this.handleROFilterSelectOptionsRelease1(obj)
                      }
                      onWrapRelease={evt =>
                        this.handleROFilterSelectWrapRelease1(evt)
                      }
                    />
                  </View>
                </View>
                <View style={styles.filterItem}>
                  <View
                    ...
                    onStartShouldSetResponder={() => true}
                    onResponderRelease={evt =>
                      this.handleROFilterSelectRelease2(evt)
                    }>
                    <Text style={styles.filterItemValText}>
                      {restingOrder.filterSelect2.value.name}
                    </Text>
                    <Image
                      style={styles.filterItemValArrow}
                      source={arrowIcon}
                  ...
                  <View style={styles.filterItemSelectOptions}>
                    <DcSelect
                      ...
                      onOptionsRelease={obj =>
                        this.handleROFilterSelectOptionsRelease2(obj)
                      }
                      onWrapRelease={evt =>
                        this.handleROFilterSelectWrapRelease2(evt)
                      }
                    />
                  </View>
                </View>
                <View style={styles.filterItem}>
                  <View
                    ...
                    onStartShouldSetResponder={() => true}
                    onResponderRelease={evt =>
                      this.handleROFilterSelectRelease3(evt)
                    }>
                    <Text style={styles.filterItemValText}>
                      {restingOrder.filterSelect3.value.name}
                    </Text>
                    <Image
                      style={styles.filterItemValArrow}
                      source={arrowIcon}
                  ...
                  <View style={styles.filterItemSelectOptions}>
                    <DcSelect
                      ...
                      onOptionsRelease={obj =>
                        this.handleROFilterSelectOptionsRelease3(obj)
                      }
                      onWrapRelease={evt =>
                        this.handleROFilterSelectWrapRelease3(evt)
                      }
                    />
                  </View>
                </View>
              ...
              <View
                ...
                <View style={styles.filterItem}>
                  <View
                    ...
                    onStartShouldSetResponder={() => true}
                    onResponderRelease={evt =>
                      this.handlePFilterSelectRelease(evt)
                    }>
                    <Text style={styles.filterItemValText}>
                      {position.filterSelect.value.name}
                    </Text>
                    <Image
                      style={styles.filterItemValArrow}
                      source={arrowIcon}
                  ...
                  <View style={[styles.filterItemSelectOptions]}>
                    <DcSelect
                      ...
                      onOptionsRelease={obj =>
                        this.handlePFilterSelectOptionsRelease(obj)
                      }
                      onWrapRelease={evt =>
                        this.handlePFilterSelectWrapRelease(evt)
                      }
                    />
                  </View>
                </View>
