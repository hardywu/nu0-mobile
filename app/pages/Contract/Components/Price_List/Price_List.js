...
import styles from './Price_List_Style';
            ...
            <View style={styles.listWrap}>
                ...
                <View style={styles.list}>
                    <View style={[styles.listHead, styles.separate, styles.mt8, styles.mb8]}>
                        <Text style={styles.listHeadItem}>价格($)</Text>
                        <Text style={styles.listHeadItem}>数量(XRP)</Text>
                    </View>
                ...
                <View style={styles.newest}>
                    <Text style={styles.newestName}>最新指数</Text>
                    <Text style={styles.newestVal}>0.362</Text>
                </View>
                {/* 最新指数结束 */}
            </View>
        );
