            ...
            <View style={[mStyles.mb10, styles.itemWrap]}>
                <View style={[mStyles.mCenterContent, styles.itemCenterContent]}>
                    <View style={styles.itemCol}>
                        <Text style={[mStyles.mBlackColor, styles.itemRowText]}>IOST/ETH</Text>
                        <Text style={[mStyles.mGrayColor, styles.itemRowText]}>2018-09-23</Text>
                    </View>
                    <View style={styles.itemCol}>
                        <Text style={[mStyles.mBlackColor, styles.itemRowText]}>0.00005100</Text>
                    </View>
                    <View style={styles.itemCol}>
                        <Text style={[mStyles.mBlackColor, styles.itemRowText]}>10000</Text>
                    </View>
                </View>
            </View>
        );
